...
- [ ] User space ведёт себя не так как задумано | priority:urgent | tags:bug | deadline:2026-09-23
...
- [x] Сделать возможность чтения того что можно прочитать из ACPI | priority:normal
  ...
  - [ ] Сделать возможность чтения скорости вентиляторов через ACPI | priority:normal
  - [ ] Сделать возможность управления вентиляторами через ACPI | priority:normal
...
- [x] Базовые вещи | priority:normal
...
- [x] Синхронизация | priority:normal
...
- [x] Архитектурные штуки | priority:normal
...
- [ ] обновить структуру всех fs от fat32 до ext2 под единый стандарт для всех fs | priority:low
  (нужно будет обновить и переписать код для всех fs чтобы они работали под единым стандартом что бы можно было зделать много пользовательских os)
